...
HD_PWD='/home/appletea/workspace_onedevice_2/fpga/RTL_Design/RTL_Design.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log watch_fnd.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source watch_fnd.tcl
