...
HD_PWD='/home/appletea/workspace_onedevice_2/fpga/RTL_Design/RTL_Design.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log watch_fnd.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source watch_fnd.tcl -notrace
